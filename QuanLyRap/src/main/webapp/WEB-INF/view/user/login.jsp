    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        <%@taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
            ...
            <body>
                ...
                <form:form action="/login/verify" method="post" modelAttribute="khachHang">
                    <div class="main">
                        <div class="dangnhap">
                            ĐĂNG NHẬP
                        </div>
                            ...
                            <div class="loginContainer">
                                ...
                                <div class="">
                                    <div class="login-container">
                                        ...
                                        <form:input path="email" type="email" id="username"
                                            placeholder="Email đăng nhập" class="form-control" required="required" />
                                        <br />
                                        <form:input path="matkhau" type="password" id="password" placeholder="Mật khẩu"
